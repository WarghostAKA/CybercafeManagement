        ...
        <table class="table table-striped">
            ...
            <c:forEach items="${sessions}" var="session">
                <tr>
                    ...
                    <td>
                        <c:if test="${session.active && session.totalCost > 0}">
                            <button class="btn btn-sm btn-primary" onclick="confirmPayment(${session.id}, ${session.totalCost})">
                                Pay Now
                            </button>
                        </c:if>
                    </td>
...
<script>
    ...
    function confirmPayment(sessionId, amount) {
